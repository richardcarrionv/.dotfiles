...
# Fake data lists
company_names = [
    "Nimbus Networks", "Pixel Pioneers", "Green Leaf Grocers", "TechnoTrends",
    "Coastal Cafe", "Summit Solutions", "Urban Oasis Landscaping", "Bright Spark Electronics"
]

addresses = [
    "1742 Sunflower Lane SW", "789 Maple Avenue", "456 Oak Street", "1010 Tech Boulevard",
    "222 Coastal Highway", "555 Mountain View Road", "333 Garden Lane", "888 Circuit Street"
]

first_names = [
    "Emily", "John", "Sarah", "Michael", "Jessica", "David", "Emma", "James"
]
